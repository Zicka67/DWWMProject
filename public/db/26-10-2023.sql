...
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES
	('DoctrineMigrations\\Version20230924092806', '2023-09-24 09:31:21', 13);
...
CREATE TABLE IF NOT EXISTS `reservation` (
  ...
  CONSTRAINT `FK_42C849557ECF78B0` FOREIGN KEY (`cours_id`) REFERENCES `cours` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_42C84955A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Listage des données de la table littlecocon2.reservation : ~33 rows (environ)
INSERT INTO `reservation` (`id`, `cours_id`, `user_id`, `dt_resa`, `dt_cours`, `payement_method`) VALUES
	...
	(70, 2, 1, '2023-09-19 06:39:21', '2023-09-23 16:00:00', 'payment-online'),
	(71, 1, 1, '2023-09-19 11:53:36', '2023-09-16 15:00:00', 'payment-online'),
	(72, 2, 1, '2023-09-19 14:57:10', '2023-09-30 15:30:00', 'payment-online'),
	(73, 1, 1, '2023-09-20 06:45:02', '2023-09-29 12:00:00', 'payment-online'),
	(74, 2, 1, '2023-09-20 14:30:03', '2023-09-14 15:00:00', 'payment-online'),
	(75, 2, 1, '2023-09-20 14:59:35', '2023-09-22 17:00:00', 'payment-online'),
	(76, 3, 1, '2023-09-20 15:02:05', '2023-09-22 15:00:00', 'payment-online'),
	(77, 2, 1, '2023-09-22 09:33:43', '2023-09-08 15:30:00', 'payment-online'),
	(81, 2, 13, '2023-09-24 09:43:15', '2023-09-24 18:00:00', 'payment-online'),
	(82, 1, 1, '2023-09-26 13:41:16', '2023-09-16 12:00:00', 'payment-online'),
	(83, 1, 1, '2023-09-27 09:14:04', '2023-09-16 15:30:00', 'payment-online'),
	(84, 2, 1, '2023-09-27 09:14:48', '2023-09-22 13:00:00', 'payment-online'),
	(85, 2, 1, '2023-10-17 06:52:33', '2023-10-20 15:00:00', 'payment-online'),
	(87, 2, 1, '2023-10-25 14:47:44', '2023-10-22 15:00:00', 'payment-online'),
	(88, 1, NULL, '2023-10-25 15:15:21', '2023-10-08 16:00:00', 'payment-online'),
	(89, 1, 1, '2023-10-25 15:20:45', '2023-10-22 15:00:00', 'payment-online');
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `is_verified`, `pseudo`, `phone_number`) VALUES
	(1, 'littlecocon@gmail.com', '["ROLE_ADMIN"]', '$2y$13$A5UfZHtJ8Qc1VZ57mU3X2.4iCkHJ3Z3Ef.yZ9eQG7P5tQy6DH6f3.', 1, 'Guillaume', '0606060606'),
	...
	(12, 'testtelephone@gmail.com', '["ROLE_USER"]', '$2y$13$BE8qo2VJt4Qk60pIljT.zeib/z73YEnacbdIqEp10WS2gA7j2wSb6', 0, 'dzdzd', '0606060606'),
	(13, 'telephone@gmail.com', '["ROLE_USER"]', '$2y$13$ZUeiNgJyRZbuKy7gotliC.yyKZVWrU1HY9b14XQN.G1Fv6SubwEz2', 0, 'TestTelephone', '0606060606'),
	(14, 'dqzdqcocon@gmail.com', '["ROLE_USER"]', '$2y$13$o0b6OOMzt8VZ4lh8RmTGd.dYSJPPQp6rTjiBjC.1uIy.04wgeyi3C', 0, 'zdzdff', '0606060606'),
	(15, 'ee@ee.fr', '["ROLE_USER"]', '$2y$13$OnXDSs0TKLnApdqBNhQfq.qQ.4I9iiSlAYu0Sd0ZX2T3TpNqKVwBi', 0, 'eeee55', '00000000000000');
