...
CREATE TABLE IF NOT EXISTS `reservation` (
  ...
  `user_firstname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_lastname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_adress` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Listage des données de la table littlecocon2.reservation : ~3 rows (environ)
INSERT INTO `reservation` (`id`, `cours_id`, `user_id`, `dt_resa`, `dt_cours`, `payement_method`, `is_paid`, `user_phone`, `user_firstname`, `user_lastname`, `user_adress`) VALUES
	...
	(64, 2, 1, '2023-11-02 13:56:37', '2023-11-12 15:00:00', 'payment-online', 1, '06 51 52 94 84', 'KEZIC', 'Guillaume', '2 rue de la ville');
...
-- Listage des données de la table littlecocon2.reset_password_request : ~1 rows (environ)
